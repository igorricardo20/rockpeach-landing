...
const services = [
	{
		...
		description:
			"Custom AI solutions and workflow automation to supercharge your business efficiency and innovation.",
		image:
			"https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=800&q=80",
		gradient: "from-fuchsia-600/60 via-blue-400/40 to-blue-600/60",
	},
	{
							 ...
							 <div className="flex flex-col justify-center items-start text-left w-full md:w-[80%] mb-4 md:mb-0">
								 <h3
									 ...
									 className={
										 ...
										 (
											 idx === 0
												 ? "bg-gradient-to-r from-fuchsia-700 via-blue-500 to-blue-400"
												 : idx === 1
