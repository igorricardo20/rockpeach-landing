    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-manrope font-bold mb-6 text-gray-900">{t.process}</h2>
                    <p className="text-lg text-gray-700 max-w-2xl mx-auto font-inter">{t.processDesc}</p>
                </motion.div>

                <motion.div variants={container} initial="hidden" animate={inView ? 'show' : 'hidden'} className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        return (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background:
                                            process.id % 2 === 0 ? 'linear-gradient(135deg, #8b6bb7 0%, #d65f7f 100%)' : 'linear-gradient(135deg, #1e8fd4 0%, #d65f7f 100%)',
                                    }}
                                >
                                ...
                                <p className="text-gray-700 font-inter">{idx === 0 ? t.frameworksDesc : idx === 1 ? t.ciDesc : idx === 2 ? t.designDesc : t.agileDesc}</p>
                            </motion.div>
                        );
                    })}
                </motion.div>
