...
const Process: React.FC = () => {
  ...
  const translations = {
    ...
    nl: {
      ...
      ci: "CI/CD Pipelines",
      ciDesc: "We automatiseren het volledige integratie- en leveringsproces voor snelle, veilige en consistente deploys.",
      design: "Design System",
      designDesc: "We creëren en implementeren robuuste design systems voor visuele consistentie en een uitzonderlijke gebruikerservaring.",
